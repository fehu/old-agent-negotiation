...
import feh.tec.agents.lite.{Message, Language, Priority, NegotiationState}
import feh.tec.agents.lite.spec.NegotiationSpecification.NegotiationDef
import feh.tec.agents.lite.spec.{MonoDefinition, ExtendableDefinition, AgentSpecification}
import feh.tec.agents.lite.spec.dsl.Agent._
import feh.tec.agents.lite.spec.dsl
